...
<div class="col-lg-8">
    <div class="page-header">
        ...
        <div class="pull-right text-right">
            <strong><b><i class="fa fa-inr"></i> <span id="moneySucc"></span>/-</b></strong>
            <div class="text-uppercase" id="trans_id">fcase234efgt</div>
        </div>
    ...
    <div class="page-content">
        ...
        <div class="pull-right text-right">
            <strong><b><i class="fa fa-inr"></i><span id="totalSucc"></span>/-</b></strong>
        </div>
        <div class="clearfix"></div>
                                                ...
                                                <div class="col-lg-8">
                                                	<div class="page-header">
                                                        <div class="pull-left text-left">
                                                            ...
                                                            <div class="text-uppercase"><span id="serviceProviderFail"> </span> <span id="serviceTyepeFail"> </span></div>
                                                        </div>
                                                        <div class="pull-right text-right">
                                                        	<strong><b><i class="fa fa-inr"></i> <span id="moneyFail"> </span>/-</b></strong>
                                                            <div class="text-uppercase" id="trans_id">fcase234efgt</div>
                                                        </div>
                                                        <div class="clearfix"></div>
                                                    ...
                                                    <div class="page-content">
                                                        ...
                                                        <div class="pull-right text-right">
                                                        	<strong><b><i class="fa fa-inr"></i> <span id="totalFail"> </span>/-</b></strong>
                                                        </div>
                                                        <div class="clearfix"></div>
                         ...
                         <div class="ChildVerticalTab_1">
                            ...
                            <div class="resp-tabs-container ver_1">
                              <span id="billtError" style="color:red;"> </span>
                                ...
                                <div><form id="billForm" action="javascript:void(0);" method="post" >
...
// 	$('#preSucc').html("Recharge processing please wait");
    ...
    $.ajax({
                type: "POST",
                url: "<?php echo  base_url();?>recharge/ad_prerecharge", 
                data: form_data,
				//datatype:"json",
...
showModal();
	//alert(form_data);
	 ...
	 $.ajax({
                type: "POST",
                url: "<?php echo  base_url();?>recharge/ad_dth_recharge_new", 
                data: form_data,
				datatype:"json",
				success: function( result )  
                { 
