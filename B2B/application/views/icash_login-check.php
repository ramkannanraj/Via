...
<?php } ?> 
                    	...
                    	<div class="panel-body">
                          ...
                          <p><span class="fa fa-key fa-2x" style="font-size:48px;"></span></p>
                                ...
                                <div class="pin" style="display:none">	
                                     ...
                                     <form method="post" action="<?php echo site_url('sendmoney/login') ?>" >
  ...
  <span id="frgSending" style="color:orange;">Sending.....</span>
     </div>
...
<script type="text/javascript">
	...
	$(document).on('submit','#frgOtp',function(e){
		...
		document.getElementById("forgetMobile").value = mobile;
	//var mobile = $('#mobile').val();	
	//$('#forgetMobile').val(mobile);
