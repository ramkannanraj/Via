...
<li class="active m-d-b" rel="tab1" id="mobiletab"><div class="imgs"><img src="<?php echo base_url()?>images/mobile.png" /></div><div  class="txts">Mobiles</div></li>
...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal" style="margin-top:50px;">
  Launch demo modal
</button>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    ...
    <!-- <div class="col-md-12 post-prepaid" id="servicetypes">
