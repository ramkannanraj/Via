              ...
              <div class="col-lg-12 col-md-12">
                <div class="widget">
                  ...
                  <div class="widget-body">
                    <div class="metro-nav">
  <form action="<?php echo site_url('transfer/other_franchise_transfer')?>" method="post" id="other_transfer_det">
                                   ...
                                   &nbsp;
                                    ...
                                    <?php //if(!empty($_REQUEST['from_date']) || !empty($_REQUEST['to_date']) ){ ?>
                                        ...
                                        <input style="margin-bottom:10px" class="btn btn-small btn-danger" type="button" value="Clear Search" id="clr" />
                                    <?php //} ?>
                                    </p>
                                </form>
                                  </div>
