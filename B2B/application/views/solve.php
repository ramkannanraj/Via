<div class="well">
    ...
    <?php foreach($query->result() as $row):?>
                           <div class="form-group">  
                            ...
                            <input type="text" name="t_id" class="form-control" value="<?php echo $row->t_id?>" readonly>
                          </div> 
						...
						<div class="form-group">  
                            ...
                            <input type="text" name="tra_id" class="form-control" value="<?php echo $row->transaction_id?>" readonly>
                          </div>         
                          <div class="form-group">
                            <label for="exampleInputEmail2">Query</label>
                            <input type="text" name="query" class="form-control" value="<?php echo $row->reason?>" readonly>
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword2">Created By ID</label>
                            <input type="text" class="form-control" name="create_id" value="<?php echo $row->create_id?>" readonly>
                          </div>
                            
						   <div class="form-group">
                            <label for="exampleInputEmail2">Reply</label>
                             <input type="text" class="form-control" name="reply" value="<?php echo $row->reply?>" readonly>
                          </div>
