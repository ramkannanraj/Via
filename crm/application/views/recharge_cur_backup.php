...
if($res->total_balance=="0"){
	echo "Your balance is very low,so you could not recharge it"; 
     ...
     <form class="form-horizontal" method="post" action="<?php echo site_url(); ?>recharge/ad_recharge" id="mobileproviderForm" name="form1">
<div class="col-md-12 post-prepaid">
    ...
    <div class="col-sm-10">
      <input type="text" name="mobilenumber" required class="trns form-control"  maxlength="10" minlength="10" onKeyPress="return isNumber(event)" id="mobilenumber_mobileprovider">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" name="amount" required class="trns form-control" id="amount_mobileprovider">
    </div>
  </div>
  
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Select Provider</label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    <div class="col-sm-10">
     ...
     <form class="form-horizontal" method="post" action="<?php echo site_url(); ?>recharge/ad_postpaid_recharge" id="mobilepostpaidproviderForm" name="form1">
     <div class="col-md-12 post-prepaid">
     <div class="form-group">
    <div class="col-sm-5">
      <input type="radio" value="prepaid" name="service_type" id="service_type" class="card_type" checked> <span> Prepaid </span> 
  ...
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Select Provider</label>
    <div class="col-sm-10">
      <select name="serviceprovider"  required id="serviceprovider_mobileprovider"  class="oddfields form-control" notEqual="-Choose-" style="margin-left:margin-left:19px;"> 
<option selected="selected" value="">-Select-</option>
