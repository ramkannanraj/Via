...
<li><strong>bene_bene_id</strong>: <?php echo $bene_id;?></li>
                                	...
                                	<form method="post" id="mmidTransaction" action="<?php echo site_url('beneficiary/mmid_transaction_process') ?>"  >								<div class="hidden">
                                ...
                                <div class="form-group col-lg-6">
                                <label >IFSC Code</label><input type="text" name="icash_mmid"   readonly value="<?php echo $ifsc_code;?>"  class="form-control"  />
                                </div>
