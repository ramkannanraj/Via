...
$(document).ready(function() {
	$('#report_distributors_details').dataTable({
    });
...
<div class="dashboard-container">
                ...
                <div class="widget">
                  ...
                  <div class="widget-body">
                    <div class="metro-nav">
                                ...
                                <table border="0" class="display" id="report_distributors_details">
    <thead>
        <tr>
    ...
    <tbody>
	 ...
	 foreach($results as $report_details_distributors){
		
		
		 ?>
     <tr>
         
          <td><?php echo $report_details_distributors->rdate;?></td>
