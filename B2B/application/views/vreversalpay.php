        	...
        	<div class="row">
                ...
                <div class="panel-body">
                	<div class="form-group">
                      <a href="<?php echo site_url('payment/viewrequestpaymentdetail') ?>" class="btn btn-primary">View Request</a>
                      <a href="<?php echo site_url('paymentreversal/viewreversalpaymentdetail') ?>" class="btn btn-primary">View Reversal</a>
  ...
  $(function() {
    $( "#operator_date").datepicker({ dateFormat: 'yy-mm-dd',changeMonth: true, changeYear: true });
                ...
                <!-- col-xs-12 ends-->
                    ...
                    <th scope="col">Smartcard Number</th>               
...
$(document).ready(function (){
    ...
    function fillgrid(){
        $("#loader").show();
        $.ajax({
            url:'<?php echo base_url() ?>paymentreversal/fillgrid',
            type:'GET'
        }).done(function (data){
            $(".fillgrid").html(data);
            $(".loader").hide();
            ...
            btntransfer.on('click', function (e){
                ...
                $.colorbox({
                href:"<?php echo base_url()?>paymentreversal/reversaltransfer/"+transferid,
                top:50,
                width:500,
