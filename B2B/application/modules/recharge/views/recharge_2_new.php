...
.back{position:fixed; width:100%; height:100%; background:#000; z-index:10002; opacity:0.5; display:none;}
.close{position:absolute; right:50px; top:20px; color:#fff; font-size:15px; cursor:pointer;}
...
$('#showMsg').hide();
$(document).ready(function(){
$('#showMsg').html('<div style="padding-top:30px;font-size:20px;"><?php echo'<b>your recharge for Rs 10 is done</b>'?></div><div><div style="padding-left:5px;"><?php echo $message['message'] ?></div><div style="padding-left:5px;"><?php echo 'Vodafone' ?></div></div>').show();
});
</script>
...
if($res->total_balance=="0"){
  ...
  <div class="form-group" onclick="open_pop();">
