...
<li><strong>bene_bene_id</strong>: <?php echo $bene_id;?></li>
                            ...
                            <form method="post" id="beneTransaction" action="<?php echo site_url('beneficiary/bene_transaction_process') ?>"  >								<div class="hidden">
                        ...
                        <!--<form method="post" action="<?php echo site_url('beneficiary/bene_transaction_process') ?>"  >
<div class="form-group">
<label class="align-left " style=" width: 110px; ">Beneficiary name</label><input type="text" name="bene_name"    readonly   value="<?php echo $bene_name;?>" class="form-control"   />

 <input type="hidden" name="card_no"   value="<?php echo $this->session->userdata('card_no');?>"  class="form-control" />
 <input type="hidden" name="sec_k"   value="<?php echo $this->session->userdata('security_key');?>" class="form-control" />
 </div>
<div class="form-group">
<label class="align-left " style=" width: 110px; ">Mobile No</label><input type="text" name="mobile_no"  readonly value="<?php echo $bene_mobile;?>" class="form-control" />
</div>
<div class="form-group">
<label class="align-left " style=" width: 110px; ">IFSC Code</label><input type="text" name="ifsc_code"   readonly value="<?php echo $ifsc_code;?>" class="form-control" />
</div>
<div class="form-group">
<label class="align-left " style=" width: 110px; ">Account No</label><input type="text" name="acc_no"  readonly value="<?php echo $acc_no;?>" class="form-control" />
</div>
<div class="form-group">
<label class="align-left " style=" width: 110px; ">Bank Name/Branch Name</label><input type="text" name="bank_branch"   readonly value="<?php echo $bank_name;?>/<?php echo $branch_name;?>" class="form-control" />
</div>
<div class="form-group">
<label class="align-left " style=" width: 110px; ">State Name/City Name</label><input type="text" name="state_city"  readonly  value="<?php echo $bene_state;?>/<?php echo $bene_city;?>" class="form-control" />
<input type="hidden" name="trans_type"   value="<?php echo $trans_type;?>" class="form-control" />
<input type="hidden" name="bene_mobile"   value="<?php echo $bene_mobile;?>" class="form-control" />
<input type="hidden" name="bene_bene_id"   value="<?php echo $bene_id;?>" class="form-control" />

<?php /*?><input type="hidden" name="icash_user_id"   value="<?php echo $icash_user_id;?>" class="field-style field-split "   /><?php */?>
